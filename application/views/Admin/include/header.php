...
<title>Propertykona Realesatate system</title>
...
<div class="site-logo">
<a href="<?php  echo base_url().'Admin/dashboard';?>"><img id="logoadm" src="<?php  echo base_url();?>dist/images/logo.png" alt="" class="img-fluid" style="height:50px;  width:50%!important;" /></a>
</div>
...
<a  class="nav-link" data-toggle="dropdown" aria-expanded="false"> 
    ...
    <div class="media">
        ...
        <div class="media-body align-self-center">
            <p class="mb-2 text-white text-uppercase font-weight-bold"> Property kona </p>
...
<li><a class="has-arrow" href=""><i  class="fa fa-cube text-blue" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Post property</a>
<ul class="collapse list-unstyled">
<li><a href="<?php  echo base_url().'Product/updateproductlist';?>">Add Post property</a></li>
<li><a href="<?php  echo base_url().'Product/productlist';?>">List Post property</a></li>
</ul>
</li>
...
<li><a class="has-arrow" href=""><i class="fa fa-cog text-green"></i>&nbsp;&nbsp;&nbsp;City</a>
<ul class="collapse list-unstyled">
<li><a href="<?php  echo base_url().'Product/updatecategory';?>">-Add city</a></li>
<li><a href="<?php  echo base_url().'Product/Categorylist';?>">-list city</a></li>


</ul>
</li>
<li><a class="has-arrow" href=""><i class="fa fa-cog text-red"></i>&nbsp;&nbsp;&nbsp;locality</a>
<ul class="collapse list-unstyled">
<li><a href="<?php  echo base_url().'Product/updatesubcat';?>">-Add locality</a></li>
<li><a href="<?php  echo base_url().'Product/Subcatlist';?>">-List locality</a></li>

</ul>
</li>
</ul>
<li><a class="has-arrow" href="icons.html"><i class="fa fa-file text-yellow"></i>&nbsp;&nbsp;&nbsp;Post Requirement</a>
<ul class="collapse list-unstyled">
<li><a href="<?php  echo base_url().'Product/updatesupplier';?>">Add Post Requirement</a></li>
<li><a href="<?php  echo base_url().'Product/supplierlist';?>">List Post Requirement</a></li>


</ul>

<li><a class="has-arrow" href="icons.html"><i class="icofont icofont-file pr-1"></i>&nbsp;&nbsp;&nbsp;User Management</a>
<ul class="collapse list-unstyled">
